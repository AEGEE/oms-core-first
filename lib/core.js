...
var emailtriggers = {//NOTE: the response is called resp because
  ...
  onUserCreation: function mailToUser(err, entry, resp){
    ...
    if(err === null){
      ...
      mail.sendMail(mailmessage, entry, null);
  ...
  //v0.1.0
  onApplicationCreation: function mailToUserAndBoardies(err, entry, resp){
    ...
    if(err === null){
      ...
      mail.sendMail(mailmessage, boardUser, null);
  ...
  //v0.1.0
  onMembershipModification: function(err, filter, searchDN, resp) {
      ...
      ldap.searchLDAP(filter,searchDN,resp, function(resp, data){
          ...
          mail.sendMail(mailmessage, data[0], null);
