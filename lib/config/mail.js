...
//v0.1.0
exports.sendMail = function(message, user, res){
...
function sendMailWithGraph(userObject, OAuthToken, res) {

var destinationEmailAddress= userObject.mail;
var displayName = userObject.name;
  ...
  wrapRequestAsCallback(OAuthToken, {
    ...
    onFailure: function (err) { //FIXME: the usage of res
      res.status(err.code);
